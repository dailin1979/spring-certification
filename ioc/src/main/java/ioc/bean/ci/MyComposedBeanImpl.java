...
@Component
public class MyComposedBeanImpl implements MyComposedBean {
    ...
    @Autowired
    public MyComposedBeanImpl(/*@Qualifier("anotherSimpleBean")*/ MySimpleBean mySimpleBean,
    ...
    @Override
    public MySimpleBean getMySimpleBean() {
        return mySimpleBean;
    }
